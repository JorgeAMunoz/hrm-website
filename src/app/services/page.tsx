...
export const metadata: Metadata = {
  ...
  description: `Full-service plumbing & heating in NYC: Boiler repair/install, radiant heat, leak detection, fire sprinklers, drain cleaning, water heaters, 24/7 emergency service & more for residential & commercial clients in all 5 boroughs.`,
  keywords: [
    ...SiteConfig.keywords,
    "boiler services NYC",
    "radiant heating NYC",
...
export default function ServicesPage() {
  return (
    <div className="container mx-auto py-16 px-4 md:px-8 lg:px-16">
      <h1 className="text-4xl font-bold text-center mb-4 text-secondary">Our Plumbing & Heating Services</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service) => (
          <Card key={service.id} id={service.id} className="flex flex-col shadow-md hover:shadow-lg transition-shadow duration-300 bg-card">
            ...
            <CardContent className="flex-grow flex flex-col justify-between">
              ...
              {/* Conditional CTA: Link to emergency page or contact page */}
              <Button
                 asChild
                 variant="outline"
